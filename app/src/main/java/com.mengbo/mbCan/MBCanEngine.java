...
public class MBCanEngine extends MBCanClient {
    private static final String TAG = "MENGBO_MBCanEngine";
    ...
    private ICanBaseCallback mCanCallback = new ICanBaseCallback() { // from class: com.mengbo.mbCan.MBCanEngine.1
        ...
        public void onCanDataCallback(final int i, final Object obj) {
            MBCanEngine.this.canHandler.postDelayed(new Runnable() { // from class: com.mengbo.mbCan.MBCanEngine.1.1
                ...
                public void run() {
                    if (obj != null) {
                        Log.d(MBCanEngine.TAG, MBCanEngine.this.mIMBLogListener + "run: " + i + ",data =" + obj.toString());
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_TURNLIGHT.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_STEERING_ANGLE.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_WHEEL.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_DOOR.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_ACCSTATUS.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_RADARSENSOR.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_SYSTEMMODE.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_HARDKEY.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_SEAT_STATUS.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_RCTA_ALARM.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_BSD_ALARM.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_DOW_ALARM.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_FUELLEVEL.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_DVR_STATUS.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_WPC_STATUS.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_SEAT_BELT_STATUS.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_TOTALODOMETER.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_AVM_STATUS.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_CHIME_STATUS.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_RADIO_FREQUENCYINFO.getValue() == i) {
                return;
            }
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_BCM_STATUS.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_ENGINE.getValue() == i) {
                if (obj != null) {
                    if (MBCanEngine.this.mCanSettingsCallback != null) {
            ...
            if (MBCanDataType.eMBCAN_CFG_AUDIO.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_CFG_VEHICLE.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_CFG_DMS.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_UPGRADE_PROGRESS.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_DTC.getValue() == i) {
                return;
            }
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_ENGINE_GEAR.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_RADIO_PROGRAMSTATE.getValue() == i || MBCanDataType.eMBCAN_INSTRUMENT_CMDREPLY.getValue() == i || MBCanDataType.eMBCAN_USB_DEVICE.getValue() == i || MBCanDataType.eMBCAN_UART_TEST_RESULT.getValue() == i) {
                return;
            }
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_FUELTANK.getValue() == i) {
                if (MBCanEngine.this.mCanSettingsCallback != null) {
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_GASPED_STATUS.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_AQS_STATUS.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_EXTERNAL_TEMP_RAW.getValue() == i) {
                return;
            }
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_LKA_STATUS.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_FRM_INFO.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_ICM_INFO.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_ICM_FAULT_INFO.getValue() == i) {
                if (obj == null || MBCanEngine.this.mCanSettingsCallback == null) {
                    return;
                }
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_ICM_DRIVE_INFO.getValue() == i) {
                return;
            }
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_CEM_FRAG.getValue() == i) {
                if (obj != null) {
                    if (MBCanEngine.this.mCanSettingsCallback != null) {
            ...
            if (MBCanDataType.eMBCAN_ICM_ALARM_INFO.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_INVERTER_STATUS.getValue() == i) {
                if (obj != null) {
                    if (MBCanEngine.this.mCanSettingsCallback != null) {
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_DVR_PARAM.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_EPB_STATUS.getValue() == i) {
            ...
            if (MBCanDataType.eMBCAN_VEHICLE_CONSUMPTION.getValue() == i) {
                if (obj == null || MBCanEngine.this.mCanSettingsCallback == null) {
                    return;
                }
            ...
            if (MBCanDataType.eMBCAN_CHARGING_RESERVE.getValue() != i || obj == null || MBCanEngine.this.mCanSettingsCallback == null) {
                return;
            }
    ...
    public String getVersion(int i) {
        ...
        Log.d(TAG, "getVersion: " + nativeCanGetVersion);
    ...
    private int canClientSubscribe(ArrayList<MBCanSubscribeBase> arrayList) {
        ...
        Log.d(TAG, "canClientSubscribe: " + nativeCanSubscribe);
    ...
    private int canClientUnSubscribe(ArrayList<MBCanSubscribeBase> arrayList) {
        ...
        Log.d(TAG, "canClientUnSubscribe: " + nativeCanUnSubscribe);
    ...
    public ArrayList<String> getCanSimultaionFileList() {
        ...
        if (arrayList != null && arrayList.size() > 0) {
            ...
            while (it.hasNext()) {
                Log.d(TAG, "getCanSimultaionFileList: fileName = " + it.next());
            }
        }
        String str = TAG;
        StringBuilder sb = new StringBuilder("getCanSimultaionFileList: size=");
    ...
    private Class getClsWithDataType(int i) {
        switch (i) {
            ...
            default:
                Log.d(TAG, "getClsWithDataType: " + i);
                return null;
        }
    }
    ...
    public <T> T getMbCanData(int i, Class<T> cls) {
        ...
        if (nativeGetCanDataWithType.getClass() != cls) {
            Log.d(TAG, "getMbCanData: Exception!!!, Class not matched.expected cls is " + cls.getSimpleName() + ",dataType = " + i);
        }
        try {
            return cls.cast(nativeGetCanDataWithType);
        } catch (Exception unused) {
            Log.d(TAG, "Exception!!! getMbCanData error, type = " + i);
            return null;
        }
    }
    ...
    public int canRadioSet(int i, int i2) {
        ...
        Log.d(TAG, "canRadioSet: cmdType = " + i + ", value = " + i2);
    ...
    private byte[] getAscllStr(String str) {
        ...
        if (!str.matches("^[A-Fa-f0-9]{12}")) {
            Log.e(TAG, "input string format error " + str);
            return null;
        }
        byte[] bArr = new byte[6];
        strToHex(str, bArr);
        Log.d(TAG, "byte array = " + Arrays.toString(bArr));
        return bArr;
    }
    ...
    private void strToHex(String str, byte[] bArr) {
        ...
        int i2 = 0;
        while (i < length) {
            bArr[i2] = (byte) (getAsciiKey((byte) str.charAt(i + 1)) | (getAsciiKey((byte) str.charAt(i)) << 4));
            i += 2;
            i2++;
        }
    }
